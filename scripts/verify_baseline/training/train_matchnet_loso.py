...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="eegnet", choices=["eegnet", "atcnet", "eegnet_s1", "eegnet_s2", "eegnet_multiscale_v1", "eegnet_multiscale_v2"], help="Base EEG encoder")
